...
document.getElementById("title-head") .innerHTML = "Model: Ferrari F8";
...
document.getElementById("11").innerHTML ="<span class='label'>Type:</span>   Supercar / High‑Performance Sports Coupe";
document.getElementById("12").innerHTML ="10,100,000 EGP";
