...
document.getElementById("title-head") .innerHTML = "Model: Audi SQ8";
document.getElementById("7").innerHTML ="<span class='label'>Drive:</span>  quattro all‑wheel drive (AWD)";
document.getElementById("8").innerHTML ="<span class='label'>Transmission:</span> Automatic";
document.getElementById("9").innerHTML ="<span class='label'>Body Style:</span> 4‑door SUV ";
document.getElementById("10").innerHTML ="<span class='label'>Seating:</span> 5 passengers";
document.getElementById("11").innerHTML ="<span class='label'>Type:</span> High‑Performance Luxury SUV";
document.getElementById("12").innerHTML ="4,000,000 EGP";
