...
document.getElementById("title") .innerHTML = "Model: Volkswagen Tiguan (2022)";
document.getElementById("1").innerHTML ="<span class='label'>Drive:</span> Front-wheel drive (AWD optional)";
document.getElementById("2").innerHTML ="<span class='label'>Transmission:</span> Automatic";
document.getElementById("3").innerHTML ="<span class='label'>Body Style:</span> 5-door SUV";
document.getElementById("4").innerHTML ="<span class='label'>Seating:</span> 5 passengers";
document.getElementById("5").innerHTML ="<span class='label'>Type:</span> Compact SUV";
document.getElementById("6").innerHTML ="1,737,000 EGP";
