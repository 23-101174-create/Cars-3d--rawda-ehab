...
document.getElementById("10").innerHTML ="<span class='label'>Seating:</span>  Luxury Sports Coupe";
document.getElementById("11").innerHTML ="<span class='label'>Type:</span> Compact SUV";
